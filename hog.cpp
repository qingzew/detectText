...
//    cv::Mat vis = get_hogdescriptor_visual_image(img, desc, cv::Size(128, 64), cv::Size(8, 8), 1, 3);
    cv::Mat vis = get_hogdescriptor_visual_image(img, desc, cv::Size(img.rows, img.cols), cv::Size(8, 8), 2, 4);
